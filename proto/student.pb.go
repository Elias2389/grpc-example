...
type Student struct {
	...
	Id    string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`     // 1 is the position
	Name  string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"` // 2 is the position
	Int32 string `protobuf:"bytes,3,opt,name=int32,proto3" json:"int32,omitempty"`
}
...
func (x *Student) GetInt32() string {
	if x != nil {
		return x.Int32
	}
	return ""
...
var file_proto_student_proto_rawDesc = []byte{
	...
	0x05, 0x69, 0x6e, 0x74, 0x33, 0x32, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x69, 0x6e,
	0x74, 0x33, 0x32, 0x22, 0x23, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e,
	...
	0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x20, 0x5a, 0x1e, 0x61, 0x65,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2d, 0x62, 0x75, 0x66, 0x66, 0x65,
	0x72, 0x73, 0x3b, 0x73, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
